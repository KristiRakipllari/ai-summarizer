...
const Hero = () => {
  return (
    <header className='w-full flex justify-center items-center flex-col relative'>
      <nav className='flex justify-between items-center w-full mb-10 pt-3'>
        <img alt="sumz_logo" src={logo} className='w-28 object-contain' />
        <button type='button' onClick={() => window.open('https://github.com/KristiRakipllari')} className='black_btn'>
          GitHub
        </button>
      </nav>
